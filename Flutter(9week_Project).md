...
| 주차 | 개발 내용 |
|------|-----------|
| 1주차 | 아이디어 구체화, 와이어프레임 및 화면 설계 |
| 2주차 | 앱 기본 구조 세팅, 라우팅 및 테마 설정 |
| 3주차 | 포모도로 타이머 기능 구현 및 UI 개선 |
| 4주차 | 집중 시간 저장 및 로컬 데이터 관리 |
| 5주차 | 통계 차트 기능(fl_chart 등) 추가 |
| 6주차 | 디자인 정리, Firebase 연동(선택), 사용자 테스트 |
| 7주차 | 디버깅, 최종 배포, 발표 자료 정리 및 GitHub 마무리 |
